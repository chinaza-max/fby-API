...
class ServerConfig {
  ...
  public FIREBASE_CLIENT_X509_CERT_URL =
    ...
    public FIREBASE_TYPE2 = process.env.FIREBASE_TYPE2;
    public FIREBASE_PROJECT_ID2 = process.env.FIREBASE_PROJECT_ID2;
    public FIREBASE_PRIVATE_KEY_ID2 = process.env.FIREBASE_PRIVATE_KEY_ID2;
    public FIREBASE_PRIVATE_KEY2 = process.env.FIREBASE_PRIVATE_KEY2;
    public FIREBASE_CLIENT_EMAIL2 = process.env.FIREBASE_CLIENT_EMAIL2;
    public FIREBASE_CLIENT_ID2 = process.env.FIREBASE_CLIENT_ID2;
    public FIREBASE_AUTH_URI2 = process.env.FIREBASE_AUTH_URI2;
    public FIREBASE_TOKEN_URI2 = process.env.FIREBASE_TOKEN_URI2;
    public FIREBASE_AUTH_PROVIDER_X509_CERT_URL2 =
      process.env.FIREBASE_AUTH_PROVIDER_X509_CERT_URL2;
    public FIREBASE_CLIENT_X509_CERT_URL2 =
      process.env.FIREBASE_CLIENT_X509_CERT_URL2;
